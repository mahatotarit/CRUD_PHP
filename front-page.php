        ...
        <div id="left-div">
            ...
            <div id="first-post">
                ...
                <div class="first-two first-second">
                    ...
                    <div class="author-span fourth-div"><span class="three-span"><?php echo $row['cate'];?></span><span
                            class="three-span"><?php echo $row['author'];?></span><span class="three-span"><?php echo $row['date'];?></span></div>
